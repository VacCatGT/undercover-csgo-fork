...
public:
	...
	__forceinline void ForcedMaterialOverride( IMaterial* mat, OverrideType type  = OverrideType::Normal, int index = -1 ) {
		return util::get_method< void( __thiscall* )( void *, IMaterial *, OverrideType, int ) >( this, FORCEDMATERIALOVERRIDE )( this, mat, type, index );
	}
};

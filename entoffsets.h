...
public:
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_nBody;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flLaggedMovementValue;
...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
		...
		INIT_XOREDNETVAR( m_flStepSize, HASH( "DT_BasePlayer" ), HASH( "m_flStepSize" ) );
		INIT_XOREDNETVAR( m_flLaggedMovementValue, HASH( "DT_BasePlayer" ), HASH( "m_flLaggedMovementValue" ) );
		...
		INIT_XOREDNETVAR( m_nBody , HASH( "DT_BaseAnimating" ), HASH( "m_nBody " ) );

...
public:
	...
	ConVar* sv_competitive_minspec;
	ConVar* cl_use_new_headbob;
	ConVar* fog_override;
	ConVar* fog_color;
	ConVar* fog_start;
	ConVar* fog_end;
...
public:
	...
	uintptr_t			     ReportHit;
	uintptr_t                InvalidateBoneCacheVerification;
	uintptr_t			     DropPhysicsMag;
	uintptr_t			     CreateDefuserRopes;
	uintptr_t				 CL_Move;
	uintptr_t				 GetWeaponPrefix;
	uintptr_t				 LookupSequence;
	uintptr_t				 GetSequenceLinearMotion;
	...
	Address                  SmokeCount;
	Address					 BeamCheckNull;
	Address					 SetupVelocity;
	Address                  IsLoadoutAllowed;
	Address                  UpdateHud;
	Address                  PainkitDefinition;
	Address                  SkipAnimationFrame;
	Address                  CalcPlayerView1;
	Address                  CalcPlayerView2;
	Address                  MaintainSequenceTransition;
	Address                  CamThink;

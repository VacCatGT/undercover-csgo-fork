...
public:
    ...
    vec3_t m_vHullMin; //12
    vec3_t m_vHullMax; //24

    vec3_t m_vDuckHullMin; //36
    vec3_t m_vDuckHullMax; //48
    vec3_t m_vDuckView; //60

    vec3_t m_vObsHullMin; //72
    vec3_t m_vObsHullMax; //84

    vec3_t m_vDeadViewHeight; //96
};

class C_CSGameRules {
public: // sorry soar once again
    ...
    virtual int SwitchToNextBestWeapon( Entity*, Weapon* );
    virtual Weapon* GetNextBestWeapon( Entity*, Weapon* );
    virtual bool ShouldCollide( int, int );
    virtual int DefaultFOV( void );
    virtual CViewVectors* GetViewVectors( void )const;
    virtual float GetAmmoDamage( Entity*, Entity*, int );
    ...
    virtual void ClientCommandKeyValues( void*, KeyValues* );
    virtual bool IsConnectedUserInfoChangeAllowed( Player* );
    ...
    virtual ang_t* GetTopDownMovementAxis( void );
    virtual int GetMaxHumanPlayers( void )const;
    virtual int GetCaptureValueForPlayer( Player* );
    virtual bool TeamMayCapturePoint( int, int );
    virtual bool PlayerMayCapturePoint( Player*, int, char*, int );
    virtual bool PlayerMayBlockPoint( Player*, int, char*, int );
    ...
    virtual int GetNextRespawnWave( int, Player* );

...
void HVH::Fakelag( ) {
	...
	if ( g_csgo.m_gamerules->m_bFreezePeriod( ) || g_cl.m_local->m_fFlags( ) & FL_FROZEN || !g_hvh.m_fake_duck && !g_tickbase.m_shift_data.m_shift_time && g_config.get_hotkey( XOR( "aimbot_exploits_teleport_key" ) ) || g_tickbase.m_shift_data.m_shift_time + 10 > g_csgo.m_globals->m_tick_count && g_config.get_hotkey( XOR( "aimbot_exploits_teleport_key" ) ) ) {
...
LABEL_5:
	...
	if ( !g_hvh.m_fake_duck && !g_tickbase.m_shift_data.m_shift_time && g_config.get_hotkey( XOR( "aimbot_hide_shots_key" ) ) || g_tickbase.m_shift_data.m_shift_time + 10 > g_csgo.m_globals->m_tick_count && !g_config.get_hotkey( XOR( "aimbot_exploits_teleport_key" ) ) )

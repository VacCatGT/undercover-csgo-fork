...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonT_Filled(const char* label, const ImVec2& size_arg, int page, int in, ImColor clr, bool border);
    ...
    IMGUI_API bool          ShowCheckbox(const char* label);
    ...
    IMGUI_API bool          InputText(bool x, const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiTextEditCallback callback = NULL, void* user_data = NULL, bool long_input = false);
    ...
    IMGUI_API bool          Hotkey(const char* label, int* k, const ImVec2& size_arg, int* type, bool dotype);
    ...
    IMGUI_API bool          Selectable22( const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2( 0, 0 ) );  // size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height

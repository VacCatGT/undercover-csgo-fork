...
// Grows the memory
//-----------------------------------------------------------------------------
inline int _UtlMemory_CalcNewAllocationCount( int nAllocationCount, int nGrowSize, int nNewSize, int nBytesItem )
{
	if ( nGrowSize )
	{ 
...
void c_utl_memory<T,I>::Grow( int num )
{
	...
	int nNewAllocationCount = _UtlMemory_CalcNewAllocationCount( m_nAllocationCount, m_nGrowSize, nAllocationRequested, sizeof(T) );
...
void c_utl_memoryAligned<T, nAlignment>::Grow( int num )
{
	...
	c_utl_memory<T>::m_nAllocationCount = _UtlMemory_CalcNewAllocationCount( c_utl_memory<T>::m_nAllocationCount, c_utl_memory<T>::m_nGrowSize, nAllocationRequested, sizeof(T) );

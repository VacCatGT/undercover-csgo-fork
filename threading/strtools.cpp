...
char* V_pretifymem( float value, int digitsafterdecimal /*= 2*/, bool usebinaryonek /*= false*/ )
{
	...
	if ( ( float )fabsf( value - ( int )value ) < 0.00001 )
	{
...
char* V_pretifynum( __int64 value )
{
	static char output[ NUM_PRETIFYMEM_BUFFERS ][ 32 ];
	static int  current;
...
void V_SplitString2( const char* pString, const char** pSeparators, int nSeparators, c_utl_vector<char*>& outStrings )
{
	outStrings.Purge( );
...
void V_SplitString( const char* pString, const char* pSeparator, c_utl_vector<char*>& outStrings )
{

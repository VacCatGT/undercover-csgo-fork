...
template <class T, class S = unsigned short, bool ML = false, class I = S, class M = c_utl_memory< UtlLinkedListElem_t<T, S>, I > >
class CUtlLinkedList
{
public:
...
inline bool CUtlLinkedList<T, S, ML, I, M>::IndexInRange( I index ) // Static method
{
	...
	// case c_utl_memory will have 'InvalidIndex == (int)-1' (which casts to 65535 in S), and will

...
//
//-----------------------------------------------------------------------------
class CFunctor : public i_ref_counted
{
public:
	CFunctor( )
	{
...
//-----------------------------------------------------------------------------
class CFunctorData : public i_ref_counted
{
public:
	virtual void ComputeValidationString( char* pString, size_t nBufLen ) const = 0;
};

class CFunctorCallback : public i_ref_counted
{
public:
...
template <class OBJECT_TYPE_PTR = i_ref_counted* >

...
template < class T, class I = unsigned short, typename L = bool ( * )( const T&, const T& ), class M = c_utl_memory< UtlRBTreeNode_t< T, I >, I > >
class CUtlRBTree
{
public:
	...
	// it IS safe to do so when using c_utl_memory as the allocator,

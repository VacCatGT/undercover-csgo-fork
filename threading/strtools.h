...
template< class T, class I > class c_utl_memory;
template< class T, class A > class c_utl_vector;
...
void V_SplitString( const char* pString, const char* pSeparator, c_utl_vector<char*, c_utl_memory<char*, int> >& outStrings );

// Just like V_SplitString, but it can use multiple possible separators.
void V_SplitString2( const char* pString, const char** pSeparators, int nSeparators, c_utl_vector<char*, c_utl_memory<char*, int> >& outStrings );

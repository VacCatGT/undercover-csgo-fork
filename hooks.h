...
public:
	...
	using IsBoxVisible_t               = int ( __thiscall* )( void*, const vec3_t&, const vec3_t& );
	using ListLeavesInBox_t            = int ( __thiscall* )( void*, vec3_t* mins, vec3_t* maxs, unsigned short* list, int list_max );
...
public:
	...
	int                      CsmShadowGetInt( );
	int                      ListLeavesInBox( vec3_t* mins, vec3_t* maxs, unsigned short* list, int list_max );
	int						 SvCompetitiveMinspecGetInt( );
	int                      SvCheatsGetBool( );
	bool                     MatWireframeGetInt( );
	bool                     R_DrawmodelstatsoverlayGetInt( );
	...
	bool                     IsConnected( );
	int				     	 IsBoxVisible( const vec3_t& mins, const vec3_t& maxs );
	bool                     IsHLTV( );
	void					 FireEvents();
...
public:
	...
	VMT m_sv_cheats;
	VMT m_sv_competitive_minspec;
	VMT m_mat_wireframe;
	VMT m_r_drawmodelstatsoverlay;
	...
	RecvVarProxy_t m_Sequence_original;
